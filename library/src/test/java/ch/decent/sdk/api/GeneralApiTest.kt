...
//  override val useMock: Boolean = false
  ...
  @Test fun `get chain props`() {
    mockWebSocket
        .enqueue("""{"method":"call","params":[2,"get_chain_properties",[]],"id":1}""", """{"id":1,"result":{"id":"2.9.0","chain_id":"17401602b201b3c45a3ad98afc6fb458f91f519bd30d1058adf6f2bed66376bc","immutable_parameters":{"min_miner_count":11,"num_special_accounts":0,"num_special_assets":0}}}""")
        .enqueue("""{"method":"call","params":[1,"database",[]],"id":2}""", """{"id":2,"result":2}""")
        .enqueue("""{"method":"call","params":[1,"login",["",""]],"id":3}""", """{"id":3,"result":true}""")

    mockHttp.enqueue("""{"id":1,"result":{"id":"2.9.0","chain_id":"17401602b201b3c45a3ad98afc6fb458f91f519bd30d1058adf6f2bed66376bc","immutable_parameters":{"min_miner_count":11,"num_special_accounts":0,"num_special_assets":0}}}""")
  ...
  @Test fun `get chain id`() {
    mockWebSocket
        .enqueue("""{"method":"call","params":[2,"get_chain_id",[]],"id":1}""", """{"id":1,"result":"17401602b201b3c45a3ad98afc6fb458f91f519bd30d1058adf6f2bed66376bc"}""")
        .enqueue("""{"method":"call","params":[1,"database",[]],"id":2}""", """{"id":2,"result":2}""")
        .enqueue("""{"method":"call","params":[1,"login",["",""]],"id":3}""", """{"id":3,"result":true}""")

    mockHttp.enqueue("""{"id":1,"result":"17401602b201b3c45a3ad98afc6fb458f91f519bd30d1058adf6f2bed66376bc"}""")
  ...
  @Test fun `get time to maintenance`() {
    mockWebSocket
        .enqueue("""{"method":"call","params":[2,"get_time_to_maint_by_block_time",["2018-10-13T22:26:02.825"]],"id":1}""", """{"id":1,"result":{"time_to_maint":86400,"from_accumulated_fees":1254865054,"block_interval":5}}""")
        .enqueue("""{"method":"call","params":[1,"database",[]],"id":2}""", """{"id":2,"result":2}""")
        .enqueue("""{"method":"call","params":[1,"login",["",""]],"id":3}""", """{"id":3,"result":true}""")

    mockHttp.enqueue("""{"id":1,"result":{"time_to_maint":86400,"from_accumulated_fees":1254865054,"block_interval":5}}""")
