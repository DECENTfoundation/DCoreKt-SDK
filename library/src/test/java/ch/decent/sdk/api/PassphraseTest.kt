...
import ch.decent.sdk.crypto.generateFromPhrase
import ch.decent.sdk.mnemonic.CHINESE_SIMPLIFIED_WORD_LIST
import ch.decent.sdk.mnemonic.CHINESE_TRADITIONAL_WORD_LIST
import ch.decent.sdk.mnemonic.ENGLISH_WORD_LIST
import ch.decent.sdk.mnemonic.TestWorldListProvider
...
class PassphraseTest : TimeOutTest() {
  ...
  @Test fun `generate private key forbrain key starting with LORDING`() {
    ...
    assertEquals(expectedKey, generateFromPhrase(Passphrase(brainKey)).base58())
  }
  ...
  @Test fun `generate private key forlowercase brain key starting with SWANKY`() {
    val brainKey = arrayOf("swanky", "culbut", "quirk", "bester", "sowl", "unceded", "musimon", "pantile", "uncity", "sandbur", "tutory", "prime", "gilled", "volute", "pluvine", "wattled")
    val expectedKey = "5Hu7yiQvKh7pS1Pmf2ipEWSz34E6oHVuxFNdHaMuBdH21jko42d"
    assertEquals(expectedKey, generateFromPhrase(Passphrase(brainKey)).base58())
  }

  @Test fun `generate private key forbrain key starting with QUIETER`() {
  ...
  @Test fun `generate private key forbrain key starting with WITSHIP`() {
  ...
  @Test fun `generate private key forbrain key starting with ARPENT`() {
  ...
  @Test fun `generate private key forbrain key starting with OPALISH`() {
  ...
  @Test fun `generate private key forbrain key starting with PUSSCAT`() {
  ...
  @Test fun `generate private key forbrain key starting with TAURIC`() {
  ...
  @Test fun `generate private key forbrain key starting with BOLSON`() {
  ...
  @Test fun `generate private key forbrain key starting with GNAWN`() {
  ...
  @Test fun `generate private key forbrain key starting with ANALYSE`() {
  ...
  @Test fun `generate private key forbrain key starting with TELLING`() {
  ...
  @Test fun `generate private key forbrain key starting with EVENT`() {
  ...
  @Test fun `generate private key forbrain key starting with VAREC`() {
  ...
  @Test fun `generate private key forbrain key starting with ORIEL`() {
  ...
  @Test fun `generate private key forbrain key starting with VAMPED`() {
  ...
  @Test fun `generate private key forbrain key starting with PARSON`() {
  ...
  @Test fun `generate private key forbrain key starting with TURTOSA`() {
  ...
  @Test fun `generate private key forbrain key starting with AMATIVE`() {
  ...
  @Test fun `generate private key forbrain key starting with OATLIKE`() {
  ...
  @Test fun `generate private key forbrain key starting with HIPPED`() {
  ...
  @Test fun `generate private key forbrain key starting with SPOFFLE`() {
  ...
  @Test fun `generate private key forbrain key starting with YUFT`() {
  ...
  @Test fun `generate private key forbrain key starting with SISTERN`() {
  ...
  @Test fun `generate private key forbrain key starting with CADRE`() {
  ...
  @Test fun `generate private key forbrain key starting with OBITUAL`() {
  ...
  @Test fun `generate private key forbrain key starting with JARKMAN`() {
  ...
  @Test fun `generate private key forbrain key starting with CEPS`() {
  ...
  @Test fun `generate private key forbrain key starting with VECTION`() {
  ...
  @Test fun `generate private key forbrain key starting with MUSSAL`() {
  ...
  @Test fun `generate private key forbrain key starting with OVA`() {
  ...
  @Test fun `generate private key forbrain key starting with RETILL`() {
  ...
  @Test fun `generate private key forbrain key starting with UPMOVE`() {
  ...
  @Test fun `generate private key forbrain key starting with NECTAR`() {
  ...
  @Test fun `generate private key forbrain key starting with IRONER`() {
  ...
  @Test fun `generate private key forbrain key starting with WAYGONE`() {
  ...
  @Test fun `generate private key forbrain key starting with EBONIST`() {
  ...
  @Test fun `generate private key forbrain key starting with SPILOMA`() {
  ...
  @Test fun `generate private key forbrain key starting with TRIKER`() {
  ...
  @Test fun `generate private key forbrain key starting with TAGSORE`() {
  ...
  @Test fun `generate private key forbrain key starting with DECIMA`() {
  ...
  @Test fun `generate private key forbrain key starting with STAR`() {
  ...
  @Test fun `generate private key forbrain key starting with XOANA`() {
  ...
  @Test fun `generate private key forbrain key starting with WEDLOCK`() {
  ...
  @Test fun `generate private key forbrain key starting with CHIT`() {
  ...
  @Test fun `generate private key forbrain key starting with SHREE`() {
