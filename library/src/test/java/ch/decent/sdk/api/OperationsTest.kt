...
//      api = DCoreSdk.createForHttp(client(), restUrl, logger)
  ...
  @Test fun `should create a transfer operation and broadcast`() {
    ...
    @Test fun `should create a transfer operation and broadcast async`() {
        val key = ECKeyPair.fromBase58(private)
        val memo = Memo("hello memo here i am again", key, Address.decode(public2), BigInteger("735604672334802432"))
        mockWebSocket
                .enqueue(
                        """{"method":"call","params":[0,"get_chain_id",[]],"id":0}""",
                        """{"id":0,"result":"17401602b201b3c45a3ad98afc6fb458f91f519bd30d1058adf6f2bed66376bc"}"""
        ...
        val test = api.broadcastApi.broadcast(trx)
                .subscribeOn(Schedulers.newThread())
                .test()
